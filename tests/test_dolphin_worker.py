...
def test_worker_dolphin_organize(mock_organize, mock_load_db, mock_resolve, mock_args, mock_logger, tmp_path):
    # Setup
...
def test_worker_dolphin_verify(mock_verify_file, mock_resolve, mock_converter_cls, mock_args, mock_logger, tmp_path):
    # Setup
    base_path = tmp_path / "roms" / "gamecube"
    base_path.mkdir(parents=True)
...
@patch("emumanager.workers.dolphin._resolve_dolphin_targets")
@patch("emumanager.workers.dolphin._verify_dolphin_file")
def test_worker_dolphin_verify_deep(mock_verify_file, mock_resolve, mock_converter_cls, mock_args, mock_logger, tmp_path):
    # Setup
