...
from emumanager.workers import psx
...
def test_psx_skips_compressed_and_logs_action(tmp_path):
    target_dir = tmp_path / "roms" / "psx"
    target_dir.mkdir(parents=True, exist_ok=True)
    rom = target_dir / "psx_game.bin"
    ...
    res = psx.worker_psx_verify(tmp_path, args, log_cb, list_files_fn)
