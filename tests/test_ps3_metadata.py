...
class TestSfoParser(unittest.TestCase):
    def test_parse_simple(self):
        ...
        # Header: Magic(4) + Version(4) + KeyTableStart(4) + DataTableStart(4) + NumEntries(4)
...
class TestPs3Metadata(unittest.TestCase):
    def test_regex_filename(self):
        ...
        # Mock is_file/is_dir to avoid FS access and force regex path if SFO scan fails/skipped
