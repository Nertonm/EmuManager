...
XML_DAT_CONTENT = (
    ...
    '        <rom name="Luigi\'s Mansion (USA).iso" '
    'size="1459978240" crc="12345678" '
    'md5="aabbccddeeff00112233445566778899" '
    'sha1="11223344556677889900aabbccddeeff00112233"/>\n'
    "    </game>\n"
    '    <game name="Super Mario Sunshine (USA)">\n'
    '        <rom name="Super Mario Sunshine (USA).iso" '
    'size="1459978240" crc="87654321" '
    'md5="99887766554433221100ffeeddccbbaa" '
    'sha1="33221100ffeeddccbbaa00998877665544332211"/>\n'
    "    </game>\n"
    "</datafile>\n"
)

# Sample ClrMamePro DAT content (use spaces, not tabs)
