...
from emumanager.gui_workers import worker_health_check, worker_organize
...
class TestWorkerCancellation:
    ...
    def test_organize_cancellation(self, mock_process_files, tmp_path):
        ...
        # Run
        worker_organize(
            tmp_path, env, args, lambda x: None, lambda x: [Path("test.nsp")]
        )
    ...
    def test_process_files_cancellation_logic(self, tmp_path):
        ...
        # Wait, the loop is: for i, fpath in enumerate(files, 1): check cancel...
